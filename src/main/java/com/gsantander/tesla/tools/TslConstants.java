...
public class TslConstants {
    ...
    public final static String SYSTEM_ADMIN_USER_NAME = "SystemAdmin";
    public final static String SYSTEM_ADMIN_PASSWORD = "Pedro1937FK";
    public final static String AUTHORITY_READ = "Read";
